...
const UserInterface = () => {
    ...
    return (
        <Fragment>
            <MetaTags>
                <meta charSet="UTF-8" />
                <title>UI | Trinxer - Pharmaceuticals </title>
                        ...
                        <div className="content">
                            <div className="row gutter-width-md">
                                <div className="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                    <p>Hosco project is created using Bootstrap 4 Framework and all of the examples below are based on it. Also, Hosco includes custom classes, plugins and scripts which are also based on our experience of Bootstrap 4 Framework.</p>
